...
export const personas: Persona[] = [
  {
    ...
    subtitle:
      'Cooper automates the data entry, submissions, renewals, and certificate work that keeps your team buried — so they can focus on clients and revenue.',
    features: [
      {
  ...
  },
  {
    ...
    subtitle:
      'Cooper triages submissions, matches risks to markets, and gets proposals out while the deal is still warm — so your brokers place more business, faster.',
    features: [
      {
        title: 'Know which submissions are worth your time',
        description:
          'Cooper reads every attachment, clears each risk against your book, and tells the retailer exactly what\'s missing — so you see only complete, in-appetite submissions worth working.',
      },
      {
        title: 'Match risks to markets automatically',
        description:
          'Cooper learns from your carriers\' guidelines and your own quoting history, then points each risk at the markets most likely to write it competitively right now — with the reasoning shown.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Cooper tracks binding authority, pre-fills binders and invoices, and prepares each state\'s surplus-lines filing on time — so placement and compliance move together instead of one waiting on the other.',
      },
    ],
    testimonialQuote:
