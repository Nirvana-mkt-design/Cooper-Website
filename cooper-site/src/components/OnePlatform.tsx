    ...
    <section className="bg-cream py-[100px]">
      <div className="max-w-[1440px] mx-auto px-[62px]">
        ...
        >
          ...
          {/* Content */}
          <div className={`grid grid-cols-2 h-[682px] ${activeIdx !== 2 ? 'overflow-hidden' : ''}`}>
            {/* Left text */}
            <div className="px-[62px] pt-[80px] pb-[60px] flex flex-col overflow-hidden h-[682px]" key={`text-${animKey}`}>
              ...
              {/* Category label */}
              <p className="font-grotesk font-medium text-[13px] tracking-[1.45px] uppercase text-dark/50 mb-[20px] shrink-0 animate-fade-in" style={{ animationDelay: '0.08s' }}>
                {active.category}
              </p>
              <h3 className="font-serif text-[38px] leading-[1.15] text-dark mb-[28px] max-w-[445px] animate-fade-in" style={{ animationDelay: '0.15s' }}>
                {active.title}
              </h3>
              <p className="font-sans text-[17.8px] leading-[1.5] text-dark/70 max-w-[491px] mb-[44px] animate-fade-blur-in" style={{ animationDelay: '0.2s' }}>
                {active.description}
              </p>
            ...
            <div className={`relative border-l border-black/[0.12] ${activeIdx !== 2 ? 'overflow-hidden' : ''}`}>
              ...
              <div className="absolute inset-0 z-10 flex items-center justify-center p-[40px]" key={`ui-${animKey}`}>
