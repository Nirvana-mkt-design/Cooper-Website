    ...
    <section className="bg-cream py-[60px] md:py-[100px]">
      <div className="max-w-[1440px] mx-auto px-[20px] md:px-[62px]">
        ...
        >
          ...
          {/* Content */}
          <div className="grid grid-cols-1 md:grid-cols-2 h-auto md:h-[682px] overflow-hidden">
            {/* Left text */}
            <div className="px-[24px] md:px-[62px] pt-[48px] md:pt-[80px] pb-[40px] md:pb-[60px] flex flex-col overflow-hidden h-auto md:h-[682px]" key={`text-${animKey}`}>
              ...
              <p className="font-sans text-[16px] md:text-[17.8px] leading-[1.5] text-dark/70 max-w-[491px] mb-[32px] md:mb-[44px] animate-fade-blur-in" style={{ animationDelay: '0.25s' }}>
                {active.description}
              </p>
            ...
            <div className="relative h-[440px] md:h-auto border-t md:border-t-0 md:border-l border-black/[0.12] overflow-hidden">
              {/* Background video */}
              <video
                autoPlay
                loop
              ...
              <div className="absolute inset-0 z-10 flex items-center justify-center">
                <div className="relative w-[420px] h-[560px] scale-[0.72] md:scale-100 origin-center" key={`ui-${animKey}`}>
                  {/* 1: Icon cards + badge */}
                  <img
                    src="/images/1.webp"
                    alt=""
