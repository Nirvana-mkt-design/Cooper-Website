...
To the extent Cooper AI processes Personal Data on Customer's behalf, the [Data Processing Addendum](/data-processing-addendum) ("**DPA**") applies and is incorporated by reference into this Agreement, and is coterminous with this Agreement. "**Personal Data**" has the meaning given to it in the DPA.
