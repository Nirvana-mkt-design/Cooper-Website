      ...
      <div className="absolute bottom-[20px] left-0 right-0 z-10 max-w-[1440px] mx-auto px-[62px]">
        <div className="flex items-center gap-[52px]">
          ...
          <div className="flex items-center gap-[52px] font-serif text-[24px] leading-[1.2] text-cream-light">
            <span className="animate-fade-blur-in" style={{ animationDelay: '1.6s' }}>Retail Brokers</span>
            <span className="animate-fade-blur-in" style={{ animationDelay: '1.75s' }}>Wholesal Brokers</span>
            <span className="animate-fade-blur-in" style={{ animationDelay: '1.9s' }}>Insurers &amp; MGS</span>
            <span className="animate-fade-blur-in" style={{ animationDelay: '2.05s' }}>Reinsurers</span>
            <span className="animate-fade-blur-in" style={{ animationDelay: '2.2s' }}>Claims TPAS</span>
          </div>
        </div>
      </div>
    </section>
