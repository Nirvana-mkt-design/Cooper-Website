const footerLinks = [
  ...
  {
    title: 'Use Cases',
    links: ['Retail Brokers', 'Wholesale Brokers', 'Insurers & MGAs', 'Reinsurers', 'Claims TPAs'],
  },
  {
    title: 'Resource',
...
export default function Footer() {
  return (
    <footer className="bg-cream-light py-[64px] px-[62px] border-t border-dark/[0.06]">
      <div className="max-w-[1440px] mx-auto">
        <div className="grid grid-cols-[1.8fr_1fr_1fr_1fr_1fr] gap-[40px] mb-[48px] pb-[48px] border-b border-dark/[0.06]">
          {/* Brand column */}
          <div>
            {/* Logo — full Cooper logo, large */}
            <div className="mb-[28px]">
              <img src="/images/cooper-logo-full.svg" alt="Cooper" className="h-[56px] w-auto" />
            </div>
